...
function AboutPage() {
    return (
        <>
            ...
            <p>I am actively looking for paid Game Development work. My expertise is within 2D projects, specifically programming in Unity and Godot with C#. I am also familiar with HTTP, Server-side, and database technologies. (I coded this website myself!)</p>
            <p></p>
